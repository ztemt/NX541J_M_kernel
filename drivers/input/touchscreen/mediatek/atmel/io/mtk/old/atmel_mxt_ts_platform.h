...
/*
#define CONFIG_MXT_PLIGIN_CAL
#define CONFIG_MXT_PLIGIN_AC
#define CONFIG_MXT_PLIGIN_PI
#define CONFIG_MXT_PLIGIN_MISC
#define CONFIG_MXT_PLIGIN_CLIP
#define CONFIG_MXT_PLIGIN_WDG
*/
