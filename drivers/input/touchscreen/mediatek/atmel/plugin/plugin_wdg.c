...
#define WD_FLAG_RESETING				P_FLAG_EV_RESETING
#define WD_FLAG_CALING					P_FLAG_EV_CALING
#define WD_FLAG_WORKAROUND_HALT			P_FLAG_EV_HALT

#define WD_FLAG_RESET					P_FLAG_EV_RESET
#define WD_FLAG_CAL						P_FLAG_EV_CAL
#define WD_FLAG_RESUME					P_FLAG_EV_RESUME
...
#define WD_FLAG_MASK_LOW			P_FLAG_EV_DONE_MASK
...
static void plugin_wdg_hook_t6(struct plugin_wdg *p, u8 status)
{
	...
	plugin_p_hook_t6(status, &obs->flag,WD_FLAG_MASK_NORMAL);
...
void plugin_interface_wdg_deinit(struct plugin_wdg *p)
{
