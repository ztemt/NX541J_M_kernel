...
#define TEMP_POS_10_THRES_PLUS_X_DEGREE 13
...
#define TEMP_NEG_10_THRES_PLUS_X_DEGREE  0
#else
#define TEMP_NEG_10_THRESHOLD  -5
#define TEMP_NEG_10_THRES_PLUS_X_DEGREE  -3
#endif
...
typedef struct {
	...
	unsigned int ZCV;
        ...
        signed int batt_health;
        signed int temperature_delta; //Temperature compensation delta value to control current when FB unblink.
#endif
} PMU_ChargerStruct;
