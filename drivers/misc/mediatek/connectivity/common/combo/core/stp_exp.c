...
#if STP_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_register_if_rx);
...
#if STP_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_register_if_tx);
#else
...
#if STP_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_register_event_cb);
#else
...
#if STP_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_register_tx_event_cb);
