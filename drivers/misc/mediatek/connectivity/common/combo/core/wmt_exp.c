...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_func_off);
#else
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_func_on);
#else
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_therm_ctrl);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_hwver_get);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_ic_info_get);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_dsns_ctrl);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_msgcb_reg);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_msgcb_unreg);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_wmt_sdio_op_reg);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_stp_wmt_sdio_host_awake);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_assert_timeout);
#endif
...
#if WMT_EXP_HID_API_EXPORT
EXPORT_SYMBOL(_mtk_wcn_wmt_assert);
#endif
