...
static unsigned int charging_hw_init(void *data)
{
	...
	bq25890_config_interface(bq25890_CON7, 0x0, 0x3, 4);	/* disable  watch dog 40 secs 0x1 */
	bq25890_config_interface(bq25890_CON7, 0x1, 0x1, 3);	/* disable charging timer safty timer */
	bq25890_config_interface(bq25890_CON7, 0x2, 0x3, 1);	/* charging timer 12h */

	bq25890_config_interface(bq25890_CONA, 0xF, 0xF, 4);	/* boost voltagte 4.998V default */
	...
	bq25890_config_interface(bq25890_CON7, 0x0, 0x3, 4);	/* disable  watch dog  secs 0x3 */
	bq25890_config_interface(bq25890_CON7, 0x1, 0x1, 3);	/* enable charging timer safty timer */
	bq25890_config_interface(bq25890_CON7, 0x2, 0x3, 1);	/* charging timer 12h */

	bq25890_config_interface(bq25890_CON5, 0x2, 0x7, 0);	/* termianation current default 192mA */
	/*Vbus current limit */
	bq25890_config_interface(bq25890_CON0, 0x0, 0x01, 6);	/* enable ilimit Pin */
	/*DPM*/
    bq25890_config_interface(bq25890_CON1, 0x1, 0x01, 0);   /* Vindpm offset  600MV */
	...
	//bq25890_config_interface(bq25890_COND, 0x13, 0x7F, 0);	/* absolute VINDPM = 2.6 + code x 0.1 =4.5V;K2 24261 4.452V */
#else
	bq25890_config_interface(bq25890_CON2, 0x1, 0x1, 4);	/* disable ico Algorithm -->bear:en */
