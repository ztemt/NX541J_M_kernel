...
#include <mt-plat/pd/pd_dbg_info.h>
#include <mt-plat/pd/tcpci.h>
#include <mt-plat/pd/rt1711h.h>
...
/* RT1711H Porting Guide
 *
 * A. DTSI Files
 *
 *	1. rt1711h i2c device, please add usb_type_c node @ i2c bus
 *
 *	i2c1: i2c@11008000 {
 ...
 *	};
 *
 *	2. TCPC USB Call Back Platform Devcie
 *	tcpc-usb-cb {
 *		compatible = "mediatek,tcpc_usb_cb";
 *	};
 *
 *	3. RT1711H TCPC property node
 *	rt1711h_pd: type_c_port0 {
 ...
 *		rt1711h,irq_gpio = <&pio 7 0x0>; // gpio number for Interrupt
 *	};
 *
 * B. EINT : please add EINT for RT1711H Interrupt
 *	at out/target/product/<project>/obj/KERNEL_OBJ/arch/arm64/boot/dts/cust.dtsi
 *	must use DWS tool to create new EINT
 *
 *	&rt1711h_pd {
 ...
 *
 * C. Kconfig
 *	please open these options for RT1711H Type-C Only Driver
 *
 *	CONFIG_RT_REGMAP=y
