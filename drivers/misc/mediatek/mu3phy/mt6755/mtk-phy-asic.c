...
#endif
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_VRT_VREF_SEL_OFST, RG_USB20_VRT_VREF_SEL, VOL_LEVL);//添加此行,与phy_init_soc()中一致
	U3PhyWriteField32((phys_addr_t) (uintptr_t) U3D_USBPHYACR1, RG_USB20_TERM_VREF_SEL_OFST, RG_USB20_TERM_VREF_SEL, VOL_LEVL); //添加此行,与phy_init_soc()中一致
	/*Wait 800 usec */
	udelay(800);
