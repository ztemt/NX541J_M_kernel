...
#if BH1745_DEBUG
#define  BH1745_FUN()               do {printk(KERN_WARNING BH1745_TAG "(%s(), %d)",         __func__,  __LINE__);} while (0)
...
#define  BH1745_WARNING(f, a...)    do {} while (0)
#endif
/*-----------------------------------------------------*/
...
#define BH1745_ONLY_ALS


#ifdef BH1745_ONLY_ALS
...
#define BH1745_CHIP_NAME    "bh1745"
