...
#endif
//ZTEMT: added by nubia camera start
int zte_camera_bkl_level;
extern atomic_t camera_bklight_set;
//ZTEMT: added by nubia camera end
...
int mtkfb_set_backlight_level(unsigned int level)
{
	...
	//ZTEMT: added by nubia camera start
	zte_camera_bkl_level = level;
	if (!atomic_read(&camera_bklight_set) || (level == 0))
	//ZTEMT: added by nubia camera end
