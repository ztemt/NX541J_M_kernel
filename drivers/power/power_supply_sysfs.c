...
static ssize_t power_supply_show_property(struct device *dev,
...
#ifdef CONFIG_NUBIA_CHARGER_HVDCP_SUPPORT
        ,"USB_HVDCP", "USB_HVDCP3"
#endif
	};
	...
	else if (off == POWER_SUPPLY_PROP_CONTROL_FUNCTION)
		return sprintf(buf, "%s\n", "Ready");
    else if (off == POWER_SUPPLY_PROP_CHARGE_DETECTION)
...
#ifdef CONFIG_NUBIA_GENERAL_CHARGE_COMMON
	POWER_SUPPLY_ATTR(function),
    POWER_SUPPLY_ATTR(detection),
#endif
};
